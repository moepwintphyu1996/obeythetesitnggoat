...
class NewVisitorTest(LiveServerTestCase):
    ...
    def create_inputbox_and_send_keys(self,row_text):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
                ...
                # Now a new user Frances comes along .
                ...
                #Frances visits the home page. There is no sign of Edith's list.
                self.browser.get(self.live_server_url)
                page_text = self.browser.find_element_by_tag_name('body').text
                self.assertNotIn('Buy peacock feathers', page_text)
                self.assertNotIn('make a fly',page_text)

                #Fances starts a new list by entering a new item.
                #He is less interesting than Edith.
                self.create_inputbox_and_send_keys('Buy milk')

                #Frances gets his own url
                frances_list_url = self.browser.current_url
                self.assertRegexpMatches(frances_list_url,'/lists/.+')
